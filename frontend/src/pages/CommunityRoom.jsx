...
const CommunityRoom = () => {
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "600px", margin: "0 auto", fontFamily: "system-ui" }}>
      <h1 style={{ color: "#10b981", marginBottom: "20px" }}>🏟 Community Room</h1>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        />
        <input
          placeholder="Room Name (Liverpool, Arsenal...)"
          value={room}
        ...
        <button
          onClick={joinRoom}
          style={{ padding: "10px 20px", background: "#10b981", color: "white", border: "none", cursor: "pointer" }}
        >
          Join Room
        </button>
      </div>
